...
describe(`gulp-stacksvg`, () => {
	...
	it(`should not create empty svg file`, () => {
	...
	it(`should correctly merge svg files`, () => {
		const stream = stacksvg()
	...
	it(`should not include invalid files`, () => {
		const stream = stacksvg()
	...
	it(`should emit error if files have the same name`, () => {
		const stream = stacksvg()
	...
	it(`should generate stack.svg if output filename is not passed`, () => {
		const stream = stacksvg()
	...
	it(`should add .svg if passed output doesn't end with this`, () => {
	...
	it(`should not add .svg if passed output ends with this`, () => {
	...
	it(`should replace the space with the hyphen when spacer is not passed`, () => {
		const stream = stacksvg()
	...
	it(`should replace the space with the passed spacer option`, () => {
	...
	it(`Should remove the space if an empty string is passed to spacer option`, () => {
		const stream = stacksvg({ spacer: `` })
	...
	it(`should replace the directory separator with the underscore`, () => {
		const stream = stacksvg()
	...
	it(`should replace the directory separator with the passed separator option`, () => {
	...
	it(`should remove the directory separator if an empty string is passed to separator option`, () => {
	...
	it(`should generate unique inner id`, () => {
		const stream = stacksvg()
	...
	it(`should include all different namespaces into final svg`, () => {
		const stream = stacksvg()
	...
	it(`should replace aliases of existing namespaces`, () => {
		const stream = stacksvg()
	...
	it(`should rename duplicate aliases of different namespaces`, () => {
		const stream = stacksvg()
	...
	it(`should remove "http://www.w3.org/1999/xlink" namespace`, () => {
		const stream = stacksvg()
	...
	it(`should not add unused namespaces`, () => {
		const stream = stacksvg()
